...
// Realistic search query patterns based on Indian automotive marketplace usage
const REALISTIC_QUERIES = [
  // VIN searches (high precision) - using realistic Indian VINs
  'EMNY7KARAJK4ATCZ7', 'WMAN35H9KRHSWX1KS', 'N272NR6NXHDACREM9', 
  'TNCGC5KE8THDZU11G', '49TT94WFVBRFM6CH7', 'YTWEK17KTBYGNMP7Z',
  
  // Popular Indian make/model combinations
  'Maruti Swift', 'Hyundai Creta', 'Tata Nexon', 'Toyota Innova',
  'Honda City', 'Maruti Baleno', 'Hyundai i20', 'Tata Harrier',
  'Toyota Fortuner', 'Honda Amaze', 'Mahindra XUV700', 'Kia Seltos',
  
  // Year-specific searches
  '2023', '2022', '2021', '2020', '2019', '2018', '2024',
  
  // Location-based searches (Indian cities)
  'Mumbai', 'Delhi', 'Bangalore', 'Hyderabad', 'Chennai', 'Kolkata',
  'Pune', 'Ahmedabad', 'Jaipur', 'Surat', 'Lucknow', 'Kanpur',
  'Nagpur', 'Indore', 'Thane', 'Bhopal', 'Visakhapatnam',
  
  // Vehicle type searches (Indian context)
  'hatchback', 'sedan', 'SUV', 'crossover', 'compact', 'premium',
  'luxury', 'MPV', 'coupe', 'convertible',
  
  // Price range searches (INR)
  '5 lakh', '10 lakh', '20 lakh', 'under 15 lakh', 'above 25 lakh',
  'budget cars', 'premium cars', 'luxury cars',
  
  // Condition searches
  'new', 'used', 'second hand', 'certified pre-owned',
  
  // Mixed natural language queries (Indian context)
  'family car Mumbai', 'fuel efficient hatchback', 'luxury sedan Delhi',
  'SUV Bangalore', 'automatic car Chennai', 'CNG car Delhi',
  'petrol car Mumbai', 'diesel SUV', 'electric car Bangalore',
  'hybrid car', 'manual transmission', 'automatic transmission',
  
  // Phone number searches (Indian format)
  '+91 98765 43210', '+91-9876543210', '9876543210',
  '+91 99999 00000', '98888 77777', '91111 22222',
  
  // Partial/typo searches (realistic user behavior)
  'maruit', 'hyundai', 'toyot', 'hond', 'tat', 'bmv', 'mercede',
  'swfit', 'creta', 'nexo', 'inova', 'cty', 'baleno',
  
  // Status searches
  'available', 'for sale', 'in stock', 'ACTIVE', 'SOLD', 'PENDING',
  
  // Feature-based searches (Indian preferences)
  'AC', 'power steering', 'power windows', 'music system',
  'central locking', 'airbags', 'ABS', 'alloy wheels'
];
